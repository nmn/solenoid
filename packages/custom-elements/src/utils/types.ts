...
export type SolenoidConfigObject = SolenoidSignalConfig | SolenoidFunctionConfig;
...
export function isSolenoidFunction(value: unknown): value is SolenoidFunctionConfig {
  return value != null
    && typeof value === 'object'
...
export function isSolenoidSignal(value: unknown): value is SolenoidSignalConfig {
  return value != null
    && typeof value === 'object'
    && SOLENOID_CUSTOM_KEY in value
